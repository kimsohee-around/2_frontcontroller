...
<body>  <!-- GET 방식  -->
		...
		<button class="search">전체</button>  <!-- type 값은 0 -->
		<button class="search">예매</button>  <!-- type 값은 102 -->
		<button class="search">결제</button>  <!-- type 값은 203 -->
		<button class="search">멤버십</button> <!-- type 값은 304 -->
		<button class="search">할인</button>  <!-- type 값은 405 -->
		<hr>
...
document.querySelectorAll(".search").forEach((btn,index)=>{
	...
	btn.addEventListener('click',()=>{
		switch(index){
			case 0: typeV=0; break;
			case 1: typeV=102; break;
			case 2: typeV=203; break;
			case 3: typeV=304; break;
			case 4: typeV=405; break;
		}
